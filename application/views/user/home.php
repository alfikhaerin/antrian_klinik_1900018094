...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('assets/user') ?>/img/IDI.png">
  <title>Klinik Praktik Dokter</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Antrian Klinik Praktik Dokter</a>
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0"><img class="masthead-avatar mb-5" src="<?php echo base_url('assets/user') ?>/img/IDI.png" alt="">Klinik Praktik Dokter</h1>
      <div class="row">
      ...
      <?php if (!empty($this->session->userdata('id_pasien'))) { ?>
        <div class="row" style="margin-top: 60px">
          <div class="col-md-3" style="border: thin solid; ">
            ...
            <H6>Spesialis Umum</H6>
          </div>
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_gigi; ?></h3>
            <H6>Spesialis Gigi</H6>
          </div>
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_im; ?></h3>
            <H6>Spesialis Imunisasi</H6>
          </div>
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_tb; ?>
              <H6>Spesialis Tuberculosis</H6>
          </div>
        </div>
      <?php } ?>
      <?php if (empty($this->session->userdata('id_pasien'))) { ?>
        <h4 class="masthead mb-0" style="margin-top: 10px !important;padding: 20px;">Selamat Datang di Klinik Praktik Dokter.
            ...
            <div class="row justify-content-md-center">
              <div class="col-md-12" style="margin-top: 20px">
                ...
                <form action="<?php echo base_url('Index/saveAntrian') ?>" method="post">
                  <div class="row">
                    <div class="col-md-2">
                      <h6><label>Pilih Spesialis</label></h6>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-2">
                      <h6><label>No Antrian Spesialis</label></h6>
                    </div>
                ...
                <div class="row text-justify">
                  <h6>Keterangan :</h6>
                  <ol>
                    <li>Spesialis Umum (SLUM)</li>
                    <li>Spesialis Gigi (SLGG) </li>
                    <li>Spesialis Imunisasi (SLIM)</li>
                    <li>SPesialis Tuberculosis (SLTB)</li>
                  </ol>
                </div>
              </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Jalan Raya Selong
            <br>No.16 Rt.07/Rw.98
          </p>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>&copy; Antrian Online klinik praktik dokter </small>
    </div>
  </section>
